...
#align(center)[
  ...
  #v(1.5cm)
  #text(10pt, fill: gray)[
    Version 1.4 #sym.dot.c May 2026 \
    #text(8pt, style: "italic")[Polly Neural TTS with Jaffna Tamil phonetic overrides]
  ]
]
...
+ Tamil IVR voice generation pipeline: Amazon Polly Neural TTS configured; Jaffna Tamil pronunciation lexicon (SSML phoneme overrides) drafted by the Tamil content lead, covering the top-20 procedures and reviewed by a panel of Northern Province native speakers; pre-rendered prompts cached in self-hosted object storage; codec compatibility validated against Ideamart's IVR pipeline (8 kHz mu-law).
