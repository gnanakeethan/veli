...
#table(
  ...
  [End of Phase 0 (Month 3)], [(a) Anchor diaspora funder soft-committed; (b) corporate form decided and conflict-of-interest policy in place; (c) signed MOUs with NGO, legal, and academic partners; (d) TTS validation panel passes ≥ 5/7; (e) hardware BOM finalised and within 25% of indicative budget; (f) baseline survey supports the base-case MAU ladder. Failing any of (a), (b), or (c): pause, do not proceed to Phase 1.],
